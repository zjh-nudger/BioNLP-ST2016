...
#            print error
            precision,recall,f_score=evaluate.evaluate_single_class_seedev(prediction=prediction,
                                                                              answer=test_set_y.eval())
            print 'epoch:%d,error:%.3f,precision:%.2f,recall:%.2f,f_score:%.2f'%(epoch,error,precision,recall,f_score)
        else:
