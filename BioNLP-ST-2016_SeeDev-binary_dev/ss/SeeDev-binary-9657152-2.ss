...
coordinated.Genetic strategies employed to identify regulators of Arabidopsis thaliana embryo development have distinguished several gene classes that affect embryogenesis.
One class of mutations, including raspberry, tinman, and abnormal suspensor ([41],
[56],
[7] and [49];
...
formation has been identified (Mayer et al. 1991).
...
[53] and [39]). As summarized in Figure 1, the lec1 mutation is pleiotropic, indicating several roles in late embryo development.
LEC1 is required for specific aspects of seed maturation. lec1
...
that aspects of both programs can occur simultaneously (Meinke 1992Meinke, 1992, 1994; West et al. 1994).
...
display any obvious vegetative or floral mutant phenotypes ([28] and [53]).
Two other LEC class genes, LEC2 and FUSCA3 (FUS3), are thought to share similar or overlapping functions with LEC1, including the specification or cotyledon identity and the maintenance of maturation ([2],
...
mutant embryos are as follows.
Embryo shape: the axes of mutant embryos
...
primordia. Defects in seed maturation: lec1 mutant embryos are intolerant of desiccation and normally die if dried on the plant.
However, lec1
embryos isolated before desiccation can be germinated to produce
fertile homozygous mutant plants.
The promoter of a 7S storage protein
gene that is normally active during wild-type embryogenesis is not
active in the lec1 mutant.
...
Ectopic expression of the LEC1
