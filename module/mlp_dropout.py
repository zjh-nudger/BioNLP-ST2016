...
def _dropout_from_layer(rng, layer, p):
    ...
    mask = srng.binomial(n=1, p=1-p, size=layer.shape)#produce the matrix of size of layer'shape
...
class DropoutHiddenLayer(HiddenLayer):
    ...
    def get_output(self,input):
        ...
        return _dropout_from_layer(self.rng, output, p=self.dropout_rate)
    ...
    def __init__(self,
        ...
        for n_in, n_out in weight_matrix_sizes[:-1]:
            ...
            next_layer = HiddenLayer(rng=rng,
                    ...
                    W=next_dropout_layer.W * (1 - dropout_rates[layer_counter]),#scale for W
