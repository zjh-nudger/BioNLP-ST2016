...
def train_conv(datasets,
    ...
    while (epoch < n_epochs):
        ...
        if shuffle_batch:
            ...
            micro_f_score,macro_f_score=evaluate_0.simple_evaluate(prediction=prediction,
    ...
    #li-输出
    evaluate_0.complete_evaluate(prediction,test_set_y.eval(),
...
if __name__=='__main__':
    ...
    train,test,words=cp.load(open('./data/out/1-1.p'))
