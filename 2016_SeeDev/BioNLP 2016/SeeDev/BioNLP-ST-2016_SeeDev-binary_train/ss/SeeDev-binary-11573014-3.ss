...
seed development.
The B3 domain is an ≈120-amino acid residue region
...
and RELATED TO ABI3/VP1 (32).
Many proteins containing B3 domains,
including ABI3/VP1, FUS3, and AUXIN RESPONSE FACTOR1, function as
transcription factors (20, 33, 34).
The B3 domain is responsible, at
...
and J.J.H., unpublished results).
All three genes are expressed
primarily during embryogenesis and are required genetically for the
completion of normal seed development.
Although they all play roles in
seed development, their specific functions have diverged.
ABI3 is a
