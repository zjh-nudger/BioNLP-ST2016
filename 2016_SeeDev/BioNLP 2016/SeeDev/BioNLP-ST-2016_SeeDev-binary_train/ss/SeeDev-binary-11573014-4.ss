...
morphologies (Fig.
5), approximately one-third possessed embryonic
rather than postgerminative characteristics.
Cotyledons of these
...
phenotypic spectrum initially resembled wild type.
The reason for this
...
establishment of functional apical meristems (Figs.
5 and 6). Together,
...
embryo formation.
In this regard, it is possible that LEC2
...
embryo-like seedlings (12).
Moreover, postembryonic expression of
...
mediates somatic embryo formation in pkl mutants.
Given our
...
Somatic plant cells generally must be induced
...
usually requires removal of the hormone(s).
LEC2 and LEC1 obviate the
...
that play roles in the initiation of somatic embryogenesis.
Our finding
that both LEC2 and LEC1 RNAs are detected at the
earliest embryonic stages tested (Fig.
4; ref.
12) opens the
possibility that both genes are involved in establishing embryogenic
competence during zygotic embryogenesis.
Thus, the role of LEC2 and
...
embryogenesis to induce embryo formation.
...
Mutations in each gene result in distinct
...
sometimes form in place of the first true leaves (12).
By contrast,
35S∷LEC2 embryo-like seedlings continued to
proliferate, producing callus, cotyledon-like and leaf-like organs in
addition to somatic embryos.
Thus, LEC1 and LEC2 may have complementary
but partially redundant functions in embryo formation.
The precise
