...
VIVIPAROUS1/ABA INSENSITIVE3 and FUSCA3.
Ectopic, postembryonic
...
confers embryonic characteristics to seedlings.
...
and central cell of the female gametophyte, respectively.
The endosperm
initially undergoes syncytial development with formation of
nuclear-cytoplasmic domains, but later cellularizes (1).
The developing
...
conceptually into two distinct phases.
During the early morphogenesis
...
systems (2–4).
The morphogenesis phase is followed by a period of
...
are synthesized at high rates and accumulate in the seed.
It is also
during the maturation phase that the embryo acquires the ability to
withstand desiccation at the final stage of seed development.
At the
end of embryogenesis, the seed consists of a mature, desiccated embryo
that is quiescent metabolically.
Although many aspects of embryogenesis
...
key roles in controlling embryo development (7).
Unlike most other
...
maturation phases.
Early in embryogenesis, LEC genes are
...
postgermination program (13, 15, 16, 18).
Thus, LEC genes
...
transcriptional regulator (12).
Ectopic expression of LEC1
...
competence to cells (12).
Thus, we hypothesized that LEC1 establishes a
...
usually expressed during maturation (20).
Thus, two LEC
...
Significant insight into the role
