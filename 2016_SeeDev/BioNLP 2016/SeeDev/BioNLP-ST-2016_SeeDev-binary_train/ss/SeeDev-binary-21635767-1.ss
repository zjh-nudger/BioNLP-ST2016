...
microarray datasets.
Genes encoding the known enzymes in the fatty acid biosynthesis
...
expression profile.
In the triacylglycerol assembly pathway, only the genes encoding
diacylglycerol acyltransferase 1 (DGAT1) and a putative cytosolic "type 3" DGAT exhibited
a similar expression pattern with genes encoding oleosins.
We also detected a large
